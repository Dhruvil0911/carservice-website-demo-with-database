...
$sql = "INSERT INTO `master_contactus1`(`mc1_carpark`, `mc1_name`, `mc1_number`) VALUES ('$park','$name','$number')";
...
$msg = $_POST['msg'];
// insert(save) record into database
$sql2 = "INSERT INTO `master_contactus`(`mc_name`, `mc_email`, `mc_number`, `mc_message`) VALUES ('$name','$email','$number','$msg')";
                            ...
                            <div class="container">
                                <div class="detail-box">
                                    <h1>
                                        ...
                                        The Best <br> Deals For Parking lots
                                    </h1>
                                    <p>
            ...
            <div class="container">
                <form action="index.php" method="POST">
                    <div class=" form-row">
                        <div class="col-lg-3">
                            ...
                            <select name="park" id="carPark" class="form-control">
              ...
              <option value="option2">Option 2</option>
                        ...
                        <div class="col-lg-3">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="jack frod " id="parkingName">
                        </div>

                        <div class="col-lg-3">
                            <label for="parkingNumber">Your Phone Number</label>
                            <input type="text" name="number" class="form-control" placeholder="+01 1234567890 " id="parkingNumber">
                        </div>
                        <div class="col-lg-3">
                            <div class="btn-container">
                                <button type="submit" name="request" class="">
                Request a call
              </button>
                            </div>
                        </div>
        ...
        <section class="service_section layout_padding-bottom">
            ...
            <g>
                    ...
                    <div class="detail-box">
                        ...
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamcoLorem ipsum dolor sit amet, consectetur adipiscing eullamco
                        </p>
                        <div>
                            <a href="">
              Read More
                            ...
                            <form action="index.php" method="POST">
                                <div class="contact_form-container">
                                    <div>
                                        ...
                                        <div class="">
                                            <input type="text" placeholder="Message" class="message_input" name="msg" required>
                                        </div>
